...
while run:
    ...
    # scaling the image
    def scale_sharp_smoothing(path, size):
    ...
    clock_face_img = scale_sharp_smoothing(clock_img_path, (clock_face_size, clock_face_size))
    h_hand_img = scale_sharp_smoothing('./assets/hourpng.png', (hour_hand_width, hour_hand_height))
    m_hand_img = scale_sharp_smoothing('./assets/minutepng.png', (minutes_hand_width, minutes_hand_height))
    s_hand_img = scale_sharp_smoothing('./assets/secpng.png', (seconds_hand_width, seconds_hand_height))
